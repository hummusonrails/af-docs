...
description: Learn how to submit a proposal to the ArbitrumDAO's governance
  ...
  then the on-chain governance UI to facilitate an on-chain vote.
...
4. After at least 7 days, navigate to the [off-chain governance UI](https://snapshot.org/#/arbitrumfoundation.eth) to create a temperature check poll that will gauge the community's interest in your proposal.

   1. Connect your wallet.
   2. Open the ArbitrumDAO [off-chain governance UI](https://snapshot.org/#/arbitrumfoundation.eth) if it isn't already open.
   ...
   4. Navigate back to your forum post and share the link to your temperature check with the community.
...
4. Choose which governor you are targeting:
   ...
   * **Core Governor**: For <a data-quicklook-from="constitutional-aip">Constitutional</a> Proposals
   * **Treasury Governor**: For <a data-quicklook-from="nonconstitutional-aip">non-Constitutional</a> Proposals
